...
points_raw = [
    ...
    (dt.datetime(2023, 1, 25, 10, 18, 40), 440, 500, 800, 700, 1100, 1000, 40, 70, 66, 0.46, 0.70, 0.75),
    (dt.datetime(2023, 1, 25, 10, 19, 20), 550, 600, 440, 800, 1050, 1050, 33, 60, 63, 0.55, 0.77, 0.75),
    (dt.datetime(2023, 1, 25, 10, 19, 40), 640, 720, 430, 970, 1040, 890, 30, 56, 77, 0.45, 0.78, 0.76),
    (dt.datetime(2023, 1, 25, 10, 19, 40), 550, 800, 390, 1050, 1050, 870, 40, 60, 70, 0.70, 0.72, 0.70),
...
if boolean0:
    ...
    if boolean_decision:
        ...
        rows = [
            [4, '2023-01-25 10:15:01', '2023-01-25 10:17:30', 0.7],
            [5, '2023-01-25 10:17:32', '2023-01-25 10:18:15', 0.66],
