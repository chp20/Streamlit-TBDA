...
# Checkbox to allow entering final dates for dataplot
...
if boolean_decision2:
    ...
    # Checkbox to plot the following data
    ...
    st.warning("Please enable 'Allow me to enter final dates for dataplot' checkbox.")
